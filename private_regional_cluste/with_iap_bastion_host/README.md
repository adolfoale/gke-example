...
1. `gcloud container clusters get-credentials --project lateral-booking-429102-a9 --zone us-central1 --internal-ip safer-cluster-iap-bastion2`
2. `gcloud compute ssh safer-cluster-iap-bastion-bastion2 --tunnel-through-iap --project lateral-booking-429102-a9 --zone us-central1-b --ssh-flag="-4 -L8888:127.0.0.1:8888 -N -q -f`
